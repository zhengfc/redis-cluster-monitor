...
public class RedisClusterConfiguration {
	...
	public RedisClusterConfiguration (String clusterNodes, long timeout, int redirects) {
		notNull(clusterNodes, "clusterNodes must not be null!");

		this.clusterNodes = new LinkedHashSet<RedisNode>();
		appendClusterNodes(commaDelimitedListToSet(clusterNodes));
		if (timeout >= 0) {
	...
	public RedisClusterConfiguration (String clusterNodes) {
